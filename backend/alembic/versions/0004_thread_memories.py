...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("summarizer_provider", sa.String(length=100), server_default="google", nullable=False),
        sa.Column("summarizer_model", sa.String(length=255), server_default="gemini-3.5-flash", nullable=False),
